...
To get the latest version of Laravel Security, simply require `"graham-campbell/security": "~3.0"` in your `composer.json` file. You'll then need to run `composer install` or `composer update` to download it and have the autoloader updated.
